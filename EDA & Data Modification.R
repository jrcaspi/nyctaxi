...
data_test$original <- 'Test'
data_test$dropoff_datetime <- NA
data_test$trip_duration <- NA
str(data_test)

# combining Train and Test files to process data together
...
## -- Data Cleaning --
## Removing 60 rows with 0 passengers, and rows with passengers more than 7
...
## -- Data Cleaning --
## There are some rides with same pickup and drop coordinates, we will remove those
summary(df$distance)
...
write.csv(train_output, "C:/Users/sonuc/Desktop/PM Project/Processed Train and Test/train_output.csv")
